...
The contains are:
- package developing folder (data_sourcer_task/package_data_sourcer_task) with all dev files;
- installable module (data_sourcer_task/dist);
- example_run.py as an example that the module works;
- txt file with a link to sourced data Google Drive folder, since unpacked it weights ~1,31Gigs. Packed it weights ~308Mb.

The main code is in *data_sourcer_task/package_data_sourcer_task/api_data_sourcer.py*.